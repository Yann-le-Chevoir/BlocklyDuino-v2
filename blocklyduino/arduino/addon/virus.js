...
Blockly.Arduino['virus_ws2812b_init'] = function (block) {
    ...
    + '};\n'
    + '#define FASTLED_ALLOW_INTERRUPTS 1 //Pour avoir la télécommande IR réactive\n'
    + '#include <FastLED.h>';
    ...
    Blockly.Arduino.definitions_['var_virus_ws2812b_init_palette'] = 'CRGBPalette16 prevPalette = CloudColors_p;\n'
    + 'CRGBPalette16 currentPalette = CloudColors_p;\n'
    + 'TBlendType    currentBlending = LINEARBLEND;\n'
    + '//uint8_t prevBrightness = 255;\n'
    + 'uint8_t brightness = 255;\n'
    + 'bool is_allume = true;\n'
    + 'uint8_t updates_per_second = 10;\n'
    ...
    + '{\n'
    + '  brightness = value;\n'
    + '  //if (abs((int)brightness - (int)prevBrightness) >= 10)\n'
    + '  //{\n'
    + '  //  ledPrevTime = 0; //Force à rafraichir vite \n'
...
Blockly.Arduino['virus_ir_init'] = function (block) {
    ...
    Blockly.Arduino.includes_['includes_tiny_ir_receiver'] = '#define IR_RECEIVE_PIN ' + irPin + '\n#define NO_LED_FEEDBACK_CODE\n#include "TinyIRReceiver.hpp" //Testé avec IRremote by shirriff 4.2.0 (ne fonctionne pas avec 4.5.0) + ATTinyCore 2.0 (9e7024945b3a873fbb2f482d88625c4d2524ba92) dans le dossier hardware.';
