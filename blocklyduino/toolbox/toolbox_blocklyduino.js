...
+   '<block type="board_base_delay">'
+     '<value name="DELAY_TIME">'
+       '<block type="virus_math_dropdown_int">'
+       '</block>'
+     '</value>'
+   '</block>'
+ '</category>'
...
+     '</value>'
+   '</block>'
+   '<!--block type="virus_logic_compare"></block-->'
...
+ '</category>'
+ '<sep></sep-->'
+ '<!--category name="%{BKY_CAT_VIRUS_CAPTEUR_SON}" categorystyle="capteur_son_category">'
+   '<block type="virus_capteur_son_init">'
+     '<value name="NB">'
+       '<block type="math_number">'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_capteur_son_on_capteur">'
+   '</block>'
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_CAT_VIRUS_IR}" categorystyle="ir_category">'
+   '<block type="virus_ir_init">'
+   '</block>'
+   '<block type="virus_ir_on_button">'
+   '</block>'
+ '</category>'
+ '<sep></sep-->'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_ws2812b_get_brightness"></block>'
+   '<!--block type="virus_ws2812b_set_brightness">'
+     '<value name="DATA">'
+       '<block type="math_number">'
+         '<field name="NUM">255</field>'
+       '</block>'
...
+   '<block type="virus_ws2812b_set_brightness">'
+   '</block>'
+   '<block type="virus_ws2812b_set_brightness2">'
+   '</block>'
+   '<block type="virus_ws2812b_get_frequence"></block>'
+   '<!--block type="virus_ws2812b_set_frequence">'
+     '<value name="DATA">'
+       '<block type="math_number">'
+         '<field name="NUM">100</field>'
+       '</block>'
...
+   '<block type="virus_ws2812b_set_frequence">'
+   '</block>'
+   '<block type="virus_ws2812b_set_frequence2">'
+   '</block>'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_ws2812b_set_colour2">'
+     '<value name="NUM">'
+       '<block type="math_number">'
+         '<field name="NUM">1</field>'
+       '</block>'
...
+   '</block-->'
+   '<block type="virus_ws2812b_allumer">'
+   '</block>'
+   '<block type="virus_ws2812b_is_allume">'
+   '</block>'
+   '<block type="virus_ws2812b_eteindre">'
+   '</block>'
+   '<block type="virus_ws2812b_set_colour_palette">'
+   '</block>'
+   '<block type="virus_ws2812b_set_colour_palette2">'
+     '<value name="COL1">'
+       '<block type="virus_ws2812b_rgb_colour">'
+       '</block>'
+     '</value>'
+     '<value name="COL2">'
+       '<block type="virus_ws2812b_rgb_colour">'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_ws2812b_set_colour_palette3">'
+     '<value name="COL1">'
+       '<block type="virus_ws2812b_rgb_colour">'
+       '</block>'
+     '</value>'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_ws2812b_set_colour_palette4">'
+     '<value name="COL1">'
+       '<block type="virus_ws2812b_rgb_colour">'
+       '</block>'
+     '</value>'
...
+     '</value>'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_rainbow">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_rainbow2">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_rainbow3">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_ocean">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_nuages">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_lave">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_foret">'
+   '</block>'
+   '<block type="virus_ws2812b_set_palette_party">'
+   '</block>'
+ '</category>'
+ '<sep></sep>'
...
+   '</block>'
+ '</category-->'
+ '<category name="%{BKY_CAT_VIRUS_TEDX}" categorystyle="tedx_category">'
+   '<block type="dragons_buttonbindings_on_true"></block>'
+   '<block type="dragons_buttonbindings_while_true"></block>'
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_CAT_COMMANDES}" categorystyle="commandes_categorie">'
+   '<block type="RobotContainer"></block>'
//+   '<block type="configureDefaultCommand"></block>'
//+   '<block type="getAutonomousCommand"></block>'
//+   '<block type="defaultCommand"></block>'
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_CAT_COMMAND_PINCE}" categorystyle="pince_categorie">'
+   '<block type="OpenPinceCommand"></block>'
+   '<block type="ClosePinceCommand"></block>'
+   '<block type="TogglePinceCommand"></block>'
+   '<block type="Toggle_Pince"></block>'
+   '<block type="Ouvre_Pince"></block>'
+   '<block type="Ferme_Pince"></block>'
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_CAT_BRAS_COMMAND}" categorystyle="bras_categorie">'
+   '<block type="LowerBrasCommand"></block>'
+   '<block type="LiftBrasCommand"></block>'
+   '<block type="Lower_Bras"></block>'
+   '<block type="Lift_Bras"></block>'
+ '</category>'
+'<sep></sep>'
+ '<category name="%{BKY_CAT_DRIVE_COMMAND}" categorystyle="drive_categorie">'
+ '</category>'
+'<sep></sep>'
+ '<category name="%{BKY_CAT_BRAS_SUBSYSTEMS}" categorystyle="Brassubsystems">'
+   '<block type="BrasSubsystem"></block>'
+ '</category>'
+ '<category name="%{BKY_CAT_DRIVE_SUBSYSTEMS}" categorystyle="Drivesubsystems">'
+   '<block type="DriveSubsystem"></block>'
+ '</category>'
+ '<category name="%{BKY_CAT_PINCE_SUBSYSTEMS}" categorystyle="Pincesubsystems">'
+   '<block type="OpenPinceSubsystem"></block>'
+   '<block type="ClosePinceSubsystem"></block>'
+   '<block type="StopPinceSubsystem"></block>'
+   '<block type="TogglePinceSubsystem"></block>'
+ '</category>'
+'</xml>';