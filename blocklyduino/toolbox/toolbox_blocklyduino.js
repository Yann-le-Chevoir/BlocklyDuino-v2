...
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_COMMAND_PINCE}" categorystyle="pince_categorie">'
+   '<block type="Ouvre_Pince"></block>'
+   '<block type="Ferme_Pince"></block>'
+ '</category>'
+ '<sep></sep>'
+ '<category name="%{BKY_BRAS_COMMAND}" categorystyle="bras_categorie">'
+   '<block type="Lower_Bras_Commande"></block>'
+   '<block type="Lift_Bras_Command"></block>'
+ '</category>'
+'<sep></sep>'
+ '<category name="%{BKY_DRIVE_COMMAND}" categorystyle="drive_categorie">'
+ '</category>'
+'</xml>';